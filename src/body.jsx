...
const Body = () => {
  ...
  const handleFormOption = () => {
    if (searchType === 'learn') {
      window.location.href = 'https://connectpesform.vercel.app/';
    } else if (searchType === 'prepare') {
      window.location.href = 'https://connectpesinterview.vercel.app/';
    }
  };

  const handleVideoCallOption = () => {
    if (searchType === 'learn') {
      window.location.href = 'https://calendly.com/vedantmarathe050104/30min';
    } else if (searchType === 'prepare') {
      window.location.href = 'https://calendly.com/vedantmarathe050104/prepare';
    }
  };
        ...
        <section style={styles.searchSection}>
          ...
          <div style={styles.radioGroup}>
            <label style={styles.radioLabel}>
              ...
              />
              <span style={styles.radioText}>You are looking forward to applying for the organization but you require additional details about the organization</span>
            </label>
            <label style={styles.radioLabel}>
              <input
                type="radio"
